let database = {
  cat: [
    ...
    [
      'Cat Care Tips, Advice & Health Information | RSPCA',
    ...
    [
      'Cat Care | Grooming | Nutrition | Disease | Behaviour | ASPCA',
    ...
    [
      'Cat Supplies | Food, Toys, Collars & Care | Pets At Home',
      'Pets at Home has a wide range of cat supplies to suit any cat; take a look at our selection of food and treats or browse our other cat products to see everything on offer!',
      'https://www.petsathome.com/shop/en/pets/cat#',
    ],
    [
      'Cats - News, views, gossip, pictures, video - The Mirror',
      'The owners of an overweight cat have hit back at online trolls claiming the enormous kitty is "on a diet" after many shared their concerns at her large...',
      'https://www.mirror.co.uk/all-about/cats',
    ],
    [
      'Complete Guide to Caring for Cats - Vetstreet',
  ...
  dog: [
    [
      'Dogs trust',
      'I feel lost and alone. Will you pick me up? Help us care for stray dogs starting the New Year without a home.Right now more owners are struggling with the impact of the pandemic, as well as rising costs of living during these next few months. Unfortunately, this makes it even more likely that dogs of any age or condition will find themselves without a home, a family, or any protection.',
    ...
    [
      'Dog Care Advice, Tips & Health Information | RSPCA',
    ...
    [
      'All Dog Breeds - Complete List of Dog Profiles - DogTime',
    ...
    [
      'Dogs for sale in Bedford, Bedfordshire - Gumtree',
      "It's extremely unfortunate that we have had to make the sad decision to rehome our sweet beautiful boy.Yogi is a 10 month old Springer x Beagle puppy. He has been microchipped, is fully vaccinated &amp; neutered and has been health checked regularly",
      'https://www.gumtree.com/dogs/bedford',
    ],
    [
      'Most Popular Dog Breeds - Good Housekeeping',
      ...
      'https://www.goodhousekeeping.com/dog-breeds/',
    ],
    [
      'Dogs | Lifeandstyle | The Guardian',
      ...
      'https://www.theguardian.com/lifeandstyle/dogs',
    ],
    [
      'Complete Guide to Caring for Dogs - Vetstreet.com',
      "The pet-owning population is becoming more and more educated on the facts about dog behavior, but there are still a number of dog behavior myths that persist. And those myths aren't just annoying for trainers like me — they can also be detrimental to your relationship with your dog!",
